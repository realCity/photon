...
public class Server
{
    ...
    private void setupDirectories(URL directoryName) throws IOException, URISyntaxException
    {
        ...
        for (File directory : new File[] { esDirectory, photonDirectory, pluginDirectory, scriptsDirectory, painlessDirectory })
        {
            directory.mkdirs();
        }
        ...
        Files.copy(loader.getResourceAsStream("modules/lang-painless/asm-debug-all-5.1.jar"), new File(painlessDirectory, "asm-debug-all-5.1.jar").toPath(),
                StandardCopyOption.REPLACE_EXISTING);
        Files.copy(loader.getResourceAsStream("modules/lang-painless/lang-painless-5.5.1.jar"), new File(painlessDirectory, "lang-painless-5.5.1.jar").toPath(),
                StandardCopyOption.REPLACE_EXISTING);
    ...
    private JSONObject addLangsToMapping(JSONObject mappingsObject)
    {
        ...
        String nameToCollectorString =
                "{\"type\":\"string\",\"index\":\"no\",\"fields\":{\"ngrams\":{\"type\":\"string\",\"analyzer\":\"index_ngram\",\"search_analyzer\":\"search_ngram\"},\"raw\":{\"type\":\"string\",\"analyzer\":\"index_raw\"}},\"copy_to\":[\"collector.{lang}\"]}";
